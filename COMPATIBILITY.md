...
### macOS / Linux
```bash
curl -fsSL https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/install.sh | bash -s essential
```
...
3. Report issues: [GitHub Issues](https://github.com/LittleYe233/OpenAgentsControl/issues)
