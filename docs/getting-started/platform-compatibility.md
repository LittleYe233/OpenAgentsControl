...
curl -fsSL https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/install.sh | bash -s core
```
...
# Profile-based installation
curl -fsSL https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/install.sh | bash -s full
```
...
```powershell
# Download the script
Invoke-WebRequest -Uri "https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/install.sh" -OutFile "install.sh"
...
curl -fsSL https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/scripts/tests/test-compatibility.sh | bash
```
...
```bash
# Clone the repo
git clone https://github.com/LittleYe233/OpenAgentsControl.git
...
```bash
curl -fsSL https://raw.githubusercontent.com/LittleYe233/OpenAgentsControl/main/install.sh > install.sh
...
4. **Report issues:**
   - [GitHub Issues](https://github.com/LittleYe233/OpenAgentsControl/issues)
